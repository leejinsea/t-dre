...
class StandardTransform:
    ...
    def _format_transform_repr(self, transform: Callable, head: str) -> List[
        str]:
...
class ImageDataset(Dataset):
    ...
    def __init__(self, root: str, transform: Optional[Callable] = None,
        ...
        if transforms is None:
            ...
            print(
                "WARNING: Argument transforms is given, transform/target_transform are ignored.")
    ...
    def __getattr__(self, key: str) -> Any:
        if hasattr(self.dataset, key):
            ...
            raise AttributeError(
                "Given dataset has no attribute \'{}\'".format(key))
